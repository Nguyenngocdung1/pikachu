        ...
        return (
            <div style={{display: 'block', marginLeft: "120px"}}>
                ...
                <div style={{marginLeft: '500px', marginTop: '20px', marginBottom: '20px'}}>
                    <div style={{border: '1px solid', width: "730px", borderTopLeftRadius: '20px', borderBottomLeftRadius:'20px', backgroundColor: 'white'}}>
                        <div style={{width: `${time}px`,height: '30px', backgroundColor: '#7CFC00', textAlign: 'center',
                            lineHeight: '30px', borderTopLeftRadius: '20px', borderBottomLeftRadius:'20px'}}> TIME
                        </div>
                    </div>
                </div>
            </div>
